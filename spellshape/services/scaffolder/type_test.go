...
func TestCheckForbiddenTypeIndexField(t *testing.T) {
	tests := []struct {
		...
		{
			name:        "should fail with forbidden spellshape keyword - id",
			index:       "id",
			shouldError: true,
		},
		{
		...
		{
			name:        "should fail with forbidden spellshape keyword - params",
			index:       "params",
			shouldError: true,
		},
		{
			name:        "should fail with forbidden spellshape keyword - appendedvalue",
			index:       "appendedvalue",
			shouldError: true,
		},
		{
			name:        "should fail with forbidden spellshape keyword - customtype keyword",
