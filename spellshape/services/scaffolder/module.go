...
import (
	...
	appanalysis "github.com/spellshape/cli/spellshape/pkg/cosmosanalysis/app"
	...
	moduleimport "github.com/spellshape/cli/spellshape/templates/module/import"
)
...
func (s Scaffolder) ImportModule(
	...
	if err != nil {
		...
		if errors.As(err, &validationErr) {
			...
			return sm, errors.New("wasm cannot be imported. Apps initialized with Spellshape <=0.16.2 must downgrade Spellshape to 0.16.2 to import wasm")
		}
		return sm, err
	}
