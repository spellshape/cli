...
func TestNewPlugin(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			pluginCfg: pluginsconfig.Plugin{Path: "github.com/spellshape"},
			expectedPlugin: Plugin{
				Error: errors.Errorf(`plugin path "github.com/spellshape" is not a valid repository URL`),
			},
		},
		{
			name:      "ok: remote plugin",
			pluginCfg: pluginsconfig.Plugin{Path: "github.com/spellshape/plugin"},
			expectedPlugin: Plugin{
				repoPath:   "github.com/spellshape/plugin",
				cloneURL:   "https://github.com/spellshape/plugin",
				cloneDir:   ".spellshape/plugins/github.com/spellshape/plugin",
				reference:  "",
				srcPath:    ".spellshape/plugins/github.com/spellshape/plugin",
				binaryName: "plugin",
			},
		},
		{
			name:      "ok: remote plugin with @ref",
			pluginCfg: pluginsconfig.Plugin{Path: "github.com/spellshape/plugin@develop"},
			expectedPlugin: Plugin{
				repoPath:   "github.com/spellshape/plugin@develop",
				cloneURL:   "https://github.com/spellshape/plugin",
				cloneDir:   ".spellshape/plugins/github.com/spellshape/plugin-develop",
				reference:  "develop",
				srcPath:    ".spellshape/plugins/github.com/spellshape/plugin-develop",
				binaryName: "plugin",
			},
		},
		{
			name:      "ok: remote plugin with @ref containing slash",
			pluginCfg: pluginsconfig.Plugin{Path: "github.com/spellshape/plugin@package/v1.0.0"},
			expectedPlugin: Plugin{
				repoPath:   "github.com/spellshape/plugin@package/v1.0.0",
				cloneURL:   "https://github.com/spellshape/plugin",
				cloneDir:   ".spellshape/plugins/github.com/spellshape/plugin-package-v1.0.0",
				reference:  "package/v1.0.0",
				srcPath:    ".spellshape/plugins/github.com/spellshape/plugin-package-v1.0.0",
				binaryName: "plugin",
			},
		},
		{
			name:      "ok: remote plugin with subpath",
			pluginCfg: pluginsconfig.Plugin{Path: "github.com/spellshape/plugin/plugin1"},
			expectedPlugin: Plugin{
				repoPath:   "github.com/spellshape/plugin",
				cloneURL:   "https://github.com/spellshape/plugin",
				cloneDir:   ".spellshape/plugins/github.com/spellshape/plugin",
				reference:  "",
				srcPath:    ".spellshape/plugins/github.com/spellshape/plugin/plugin1",
				binaryName: "plugin1",
			},
		},
		{
			name:      "ok: remote plugin with subpath and @ref",
			pluginCfg: pluginsconfig.Plugin{Path: "github.com/spellshape/plugin/plugin1@develop"},
			expectedPlugin: Plugin{
				repoPath:   "github.com/spellshape/plugin@develop",
				cloneURL:   "https://github.com/spellshape/plugin",
				cloneDir:   ".spellshape/plugins/github.com/spellshape/plugin-develop",
				reference:  "develop",
				srcPath:    ".spellshape/plugins/github.com/spellshape/plugin-develop/plugin1",
				binaryName: "plugin1",
			},
		},
		{
			name:      "ok: remote plugin with subpath and @ref containing slash",
			pluginCfg: pluginsconfig.Plugin{Path: "github.com/spellshape/plugin/plugin1@package/v1.0.0"},
			expectedPlugin: Plugin{
				repoPath:   "github.com/spellshape/plugin@package/v1.0.0",
				cloneURL:   "https://github.com/spellshape/plugin",
				cloneDir:   ".spellshape/plugins/github.com/spellshape/plugin-package-v1.0.0",
				reference:  "package/v1.0.0",
				srcPath:    ".spellshape/plugins/github.com/spellshape/plugin-package-v1.0.0/plugin1",
				binaryName: "plugin1",
			},
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			p := newPlugin(".spellshape/plugins", tt.pluginCfg)
...
func TestPluginLoad(t *testing.T) {
	...
	makeGitRepo := func(t *testing.T, name string) (string, *git.Repository) {
		...
		repoDir := t.TempDir()
		scaffoldPlugin(t, repoDir, "github.com/spellshape/"+name, false)
		require.NoError(err)
...
func scaffoldPlugin(t *testing.T, dir, name string, sharedHost bool) string {
	...
	gomod.AddReplace("github.com/spellshape/cli", "", modpath, "")
	// Save go.mod
