...
import (
	...
	"github.com/spellshape/cli/spellshape/pkg/cliui/view/errorview"
	"github.com/spellshape/cli/spellshape/pkg/cosmosfaucet"
	"github.com/spellshape/cli/spellshape/pkg/dirchange"
	...
	"github.com/spellshape/cli/spellshape/pkg/xhttp"
		...
		for {
			...
			case <-c.serveRefresher:
				...
				case errors.As(err, &validationErr):
					...
					err = fmt.Errorf("%w\nsee: https://github.com/spellshape/cli#configure", err)
				...
				case errors.As(err, &startErr):
					...
					if parsedErr == "" {
						...
						command := colors.SprintFunc(colors.White)("spellshape chain serve --reset-once")
