...
const (
	...
	govDependencyWarning = `⚠️ If your app has been scaffolded with Spellshape CLI 0.16.x or below
...
func scaffoldModuleHandler(cmd *cobra.Command, args []string) error {
	...
	// https://github.com/spellshape/cli/issues/818#issuecomment-865736052
	for _, name := range dependencies {
		if name == "Gov" {
