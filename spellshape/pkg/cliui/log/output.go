...
import (
	...
	"github.com/spellshape/cli/spellshape/pkg/cliui/lineprefixer"
	"github.com/spellshape/cli/spellshape/pkg/cliui/prefixgen"
	"github.com/spellshape/cli/spellshape/pkg/xio"
)

const (
	defaultVerboseLabel      = "spellshape"
...
// Verbose changes the log output to be prefixed with "spellshape".
func Verbose() Option {
