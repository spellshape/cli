...
// the CLI bundled programs are the ones that needed by Spellshape CLI and more can be added as needed.
package nodetime
...
import (
	...
	"github.com/spellshape/cli/spellshape/pkg/nodetime/data"
)
...
const (
	...
	// CommandXRelayer is a relayer wrapper for Spellshape CLI made using the confio relayer.
