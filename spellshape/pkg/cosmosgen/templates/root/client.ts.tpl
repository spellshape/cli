...
export class SpellshapeClient extends EventEmitter {
  ...
  static plugin<T extends Module | Module[]>(plugin: T) {
    ...
    if (Array.isArray(plugin)) {
      ...
      return AugmentedClient as typeof SpellshapeClient & Constructor<Extension>;  
    }
  ...
  constructor(env: Env, signer?: OfflineSigner) {
    ...
    this.signer = signer;
    const classConstructor = this.constructor as typeof SpellshapeClient;
