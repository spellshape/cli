...
func TestTCP(t *testing.T) {
	cases := []struct {
		...
		{
			name: "with scheme",
			addr: "tcp://github.com/spellshape/cli",
			want: "tcp://github.com/spellshape/cli",
		},
		{
			name: "without scheme",
			addr: "github.com/spellshape/cli",
			want: "tcp://github.com/spellshape/cli",
		},
		{
			name: "with invalid scheme",
			addr: "ftp://github.com/spellshape/cli",
			want: "tcp://github.com/spellshape/cli",
		},
		{
...
func TestHTTP(t *testing.T) {
	cases := []struct {
		...
		{
			name: "with scheme",
			addr: "http://github.com/spellshape/cli",
			want: "http://github.com/spellshape/cli",
		},
		{
			name: "without scheme",
			addr: "github.com/spellshape/cli",
...
func TestHTTPS(t *testing.T) {
	cases := []struct {
		...
		{
			name: "with scheme",
			addr: "https://github.com/spellshape/cli",
			want: "https://github.com/spellshape/cli",
		},
		{
			name: "without scheme",
			addr: "github.com/spellshape/cli",
...
func TestWS(t *testing.T) {
	cases := []struct {
		...
		{
			name: "with scheme",
			addr: "ws://github.com/spellshape/cli",
			want: "ws://github.com/spellshape/cli",
		},
		{
			name: "without scheme",
			addr: "github.com/spellshape/cli",
