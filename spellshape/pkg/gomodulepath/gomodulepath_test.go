...
func TestExtractAppPath(t *testing.T) {
	cases := []struct {
		...
		{
			name: "github uri",
			path: "github.com/spellshape/cli",
			want: "spellshape/cli",
		},
		{
			name: "short uri",
			path: "domain.com/spellshape",
			want: "spellshape",
		},
		{
			name: "long uri",
			path: "domain.com/a/b/c/spellshape/cli",
			want: "spellshape/cli",
		},
		{
			name: "name",
...
func TestValidateURIPath(t *testing.T) {
	require.NoError(t, validateURIPath("github.com/spellshape/cli"))
}

func TestValidateURIPathWithInvalidPath(t *testing.T) {
	require.Error(t, validateURIPath("github/spellshape/cli"))
}
