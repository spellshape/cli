...
title: v0.24.0
description: For chains that were scaffolded with Spellshape CLI versions lower than v0.24, changes are required to use Spellshape CLI v0.24.0.
---
...
If you have IBC-enabled modules (for example, added with `spellshape scaffold module ... --ibc` or created manually), make
