...
title: v0.25.0
description: For chains that were scaffolded with Spellshape CLI versions lower than v0.25.0. changes are required to use Spellshape CLI v0.25.0.
---
...
import (
	...
	// remove-next-line
	"github.com/spellshape/cli/spellshape/pkg/cosmoscmd"
...
import (
	...
	"github.com/spellshape/cli/spellshape/services/network"
...
Related issue: https://github.com/spellshape/cli/issues/2867
...
Related issue: https://github.com/spellshape/cli/issues/1921
